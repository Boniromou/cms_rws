...
#   stg - Staging
#   prd - Production
role :app, 'mo-mock-cms-app01.rnd.laxino.com'

role :cronjob_app, 'mo-mock-cms-app01.rnd.laxino.com'
...
set :cluster_port, 10065
set :virtual_server_name, 'mo-mock-cms-vapp01.rnd.laxino.com'
