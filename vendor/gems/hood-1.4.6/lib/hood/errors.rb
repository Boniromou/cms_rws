module Hood
  ...
  class VoidTransactionNotMatch < BadRequest
  end

  class VoidTransactionNotExist < BadRequest
  end
  ...
  class InvalidSessionToken < BadRequest
  end

  class AmountNotMatch < BadRequest
    def initialize(data=nil)
      super('expire amount not match',data)
    end
  end

  class CreditNotExpired < BadRequest
    def initialize(data=nil)
      super('existing credit not yet expired',data)
    end
  end
