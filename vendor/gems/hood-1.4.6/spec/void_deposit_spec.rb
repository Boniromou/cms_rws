...
RSpec.describe Cashier, "void_deposit" do
  ...
  before(:each) do
    ...
    Player.dataset.insert(:id=>123,:login_name=>'abc',:currency_id=>1,:property_id=>1000,:shareholder=>'holder',:balance=>10000,
  ...
  it "AmountNotEnough" do
    ib = {:amt=>100.1,:login_name=>'abc',:property_id=>1000,:ref_trans_id=>'T1'}
    deposit(ib)
    ib = {:amt=>100.1,:login_name=>'abc',:property_id=>1000,:ref_trans_id=>'T2'}
    withdraw(ib)
    ib = {:amt=>100.1,:login_name=>'abc',:property_id=>1000,:ref_trans_id=>'T1'}
    ob = void_deposit(ib)
