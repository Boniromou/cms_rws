module LaxSupport
  # This module is completely from AcitveSupport::Callbacks.
  #
          ...
          class_eval <<-"end_eval"
            ...
            def self.#{callback}_callback_chain
              ...
              if superclass.respond_to?(:#{callback}_callback_chain)
                CallbackChain.new((superclass.#{callback}_callback_chain + @#{callback}_callbacks).uniq)
              else
                @#{callback}_callbacks
              end
            end

            def self.#{callback}_callbacks
              @#{callback}_callbacks
            end
          end_eval
        end
