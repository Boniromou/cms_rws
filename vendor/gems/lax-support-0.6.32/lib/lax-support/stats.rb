...
module LaxSupport
  class Stats
    attr_reader :sum, :sumsq, :n, :min, :max, :last_value
    ...
    def dump(msg = "", out=STDERR)
      out.puts "#{msg}: [#{@name}]: LAST=%0.4%, SUM=%0.4f, SUMSQ=%0.4f, N=%0.4f, MEAN=%0.4f, SD=%0.4f, MIN=%0.4f, MAX=%0.4f" % [@last_value, @sum, @sumsq, @n, mean, sd, @min, @max]
    end
